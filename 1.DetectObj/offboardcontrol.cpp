...
int main(int argc, char **argv)
{
    ...
    while(true){    
        ...
        ud = 0;
        cam->process();
            if(0.5 <= cam->objPos[0].second && cam->objPos[0].second<= 1.5){
            
                if(cam->objPos[0].first.tl().x < 320 && cam->objPos[0].first.br().x <320){
                    fb = 0;
                    lr = 1;
                    ud = 0;
                }
                ...
                if(cam->objPos[0].first.tl().x < 320 && 320 < cam->objPos[0].first.br().x){
                    if(320-cam->objPos[0].first.tl().x <= cam->objPos[0].first.br().x-320){
                        fb = 0;
                        lr = 1;
                        ud = 0; 
                    }
